...
//                         labelText:  "Enter Your Full Name...",labelStyle: TextStyle(fontWeight: FontWeight.bold),
...
//                       decoration: InputDecoration(
//                         labelText:  "Enter Your Roll Number...",labelStyle: TextStyle(fontWeight: FontWeight.bold),
//                         icon: Icon(Icons.person),
//                       ),
//                     ),
//                   ),
...
//                       decoration: InputDecoration(
//                         labelText:  "Enter Your Mobile Number...",labelStyle: TextStyle(fontWeight: FontWeight.bold),
...
//                       decoration: InputDecoration(
//                         labelText:
//                         "Create Password...",labelStyle: TextStyle(fontWeight: FontWeight.bold),
...
//                       callback: () async {
//
//                         if(name == null || fname == null || email == null || number == null
//                             ||admissionValue == null || createPassword == null || confirmPassword == null)
//                         {
//
...
//                               return CustomAlertDialog(
//                                 title: 'Wrong name!!',
//                                 message: 'Please use only small and capital letters or space only.\nFor Example "Ashutosh Agnihotri"',
//                                 onPressed: () {
//                                   Navigator.of(context).pop();
//                                 },
//                               );
...
//                                 message: 'Please use correct roll number format.\nFor Example "M200685CA\m200685ca"',
//                                 onPressed: () {
//                                   Navigator.of(context).pop();
//                                 },
//                               );
...
//                           );
//                         }
//                         else if(object.checkMoreOnEmail(email, name, fname) == false)
//                         {
//
//                           showDialog(context: context,
//                             builder: (BuildContext context) {
...
//                               return CustomAlertDialog(
//                                 title: 'Wrong format!!',
//                                 message: 'Please use at least 6 length password.',
//                                 onPressed: () {
//                                   Navigator.of(context).pop();
//                                 },
//                               );
...
//                           );
//                         }
//                         else if(object.validatePass(createPassword, confirmPassword) == false)
//                         {
//                           showDialog(context: context,
//                             builder: (BuildContext context) {
//                               return CustomAlertDialog(
//                                 title: 'Something Missmatch!!',
//                                 message: 'Please make password and confirm password as same.',
//                                 onPressed: () {
//                                   Navigator.of(context).pop();
//                                 },
//                               );
...
//                           Future<bool> exists = checkAdmissionYear.serachAdmissionYear(admissionValue) ;
//                           bool x = await exists;
//                           if(x == true)
//                           {
//                             showDialog(context: context,
...
//                           Future<bool> exists = checkEmail.serachEmailInStudents(email) ;
//                           bool x = await exists;
//                           if(x == true)
//                           {
//                             showDialog(context: context,
...
//                                   message: 'You already registered with this email id.',
//                                   onPressed: () {
//                                     Navigator.push(context, MaterialPageRoute(builder: (context) => HomePage()));
//                                   },
//                                 );
...
//   final String text;
//
//   const Button({ required Key key,  required this.callback,  required this.text}) : super(key: key);
//   @override
//   Widget build(BuildContext context) {
//     return Container(
//       padding: const EdgeInsets.all(8.0),
